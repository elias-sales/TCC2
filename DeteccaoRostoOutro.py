...
import cv2 as cv
import argparse
def detectAndDisplay(frame):#FUNÇÃO QUE DETECTA O ROSTO E MOSTRA NO DISPLAY
...
parser.add_argument('--eyes_cascade', help='Path to eyes cascade.', default='C:/Users/elias/Documents/Engenharia_Eletrica/Eye_Tracking/TCC_2/Deteccao_facial/haarcascade_eye_tree_eyeglasses.xml')
